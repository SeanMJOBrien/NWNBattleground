...
object oItem = CreateItemOnObject("arrow1",OBJECT_SELF,99);
...
object oRecolor = CopyItemAndModify(oItem,ITEM_APPR_TYPE_WEAPON_COLOR,ITEM_APPR_WEAPON_COLOR_TOP,Random(3)+1,TRUE);
DestroyObject(oItem);
object oRecolor2 = CopyItemAndModify(oRecolor,ITEM_APPR_TYPE_WEAPON_COLOR,ITEM_APPR_WEAPON_COLOR_MIDDLE,Random(3)+1,TRUE);
DestroyObject(oRecolor);
object oRecolor3 = CopyItemAndModify(oRecolor2,ITEM_APPR_TYPE_WEAPON_COLOR,ITEM_APPR_WEAPON_COLOR_BOTTOM,Random(3)+1,TRUE);
...
DelayCommand(2.9f,ActionEquipItem(oFinal,INVENTORY_SLOT_ARROWS));
}
