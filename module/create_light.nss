...
switch(iRoll)
        {
        case 1:
        oItem = CreateItemOnObject("padded",OBJECT_SELF);
        break;
        case 2:
        oItem = CreateItemOnObject("ftr_leather",OBJECT_SELF);
        break;
        case 3:
        oItem = CreateItemOnObject("stleather",OBJECT_SELF);
        break;
        case 4:
        oItem = CreateItemOnObject("ringmail",OBJECT_SELF);
        break;
        }
