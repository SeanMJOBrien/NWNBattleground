...
if (iHD>=40) iHD=40;
///////////////////////////////////////////////////
object oItem = CreateItemOnObject("monkrobe",OBJECT_SELF);
...
object oSimple = CopyItemAndModify(oItem,ITEM_APPR_TYPE_ARMOR_MODEL,ITEM_APPR_ARMOR_MODEL_ROBE,Random(2)+3,TRUE);
DestroyObject(oItem);
object oSimple1 = CopyItemAndModify(oSimple,ITEM_APPR_TYPE_ARMOR_COLOR ,ITEM_APPR_ARMOR_COLOR_CLOTH1,Random(44)+101,TRUE);
DestroyObject(oSimple);
object oSimple2 = CopyItemAndModify(oSimple1,ITEM_APPR_TYPE_ARMOR_COLOR ,ITEM_APPR_ARMOR_COLOR_CLOTH2,Random(44)+101,TRUE);
...
DelayCommand(2.2f,ActionEquipItem(oFinal,INVENTORY_SLOT_CHEST));
...
SetName(oFinal,"Supermonk "+sName);
}
