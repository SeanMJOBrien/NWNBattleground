...
void main()
{
    ...
    // Combat
    AI_SetSpawnInSpeakArray(AI_TALK_ON_COMBAT_ROUND_EQUAL, 10, 4, "I will feast on your flesh!", "More slaves for the master's mines!", "Death before deafeat!", "Fear me!");
    AI_SetSpawnInSpeakArray(AI_TALK_ON_COMBAT_ROUND_THEM_OVER_US, 10, 4, "You not so tough!", "I shall die in victorious battle!", "Gruumsh shall take my soul!", "I am no coward! I fight on!");
    AI_SetSpawnInSpeakArray(AI_TALK_ON_COMBAT_ROUND_US_OVER_THEM, 10, 4, "No quarter!", "Gruumsh shall claim your souls!", "Kill the lot of them!", "Pray for death!");

    // Our leader shouts!
    // - As this is a human, very orderly
    AI_SetSpawnInSpeakValue(AI_TALK_ON_LEADER_SEND_RUNNER, "Snaga! Go find help!");
    AI_SetSpawnInSpeakValue(AI_TALK_ON_LEADER_ATTACK_TARGET, "Attack this one!");
