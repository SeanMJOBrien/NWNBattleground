...
************************* [Targeting] *****************************************/
    ...
    //SetAIInteger(AI_MAX_TURNS_TO_ATTACK_ONE_TARGET, 8);
    ...
    if (d6() <= 3) AI_SetAITargetingValues(TARGETING_MANTALS, TARGET_LOWER, i1, i12);
    ...
    if (d6() <= 2) AI_SetAITargetingValues(TARGETING_RANGE, TARGET_HIGHER, i2, i9);
    ...
    if (d6() <= 3) AI_SetAITargetingValues(TARGETING_BAB, TARGET_LOWER, i1, i4);
    ...
    if (d6() <= 3) AI_SetAITargetingValues(TARGETING_HITDICE, TARGET_LOWER, i1, i3);
...
//    SetSpawnInCondition(AI_FLAG_FLEEING_NEVER_FIGHT_IMPOSSIBLE_ODDS, AI_TARGETING_FLEE_MASTER);
    ...
    SetAIInteger(AI_DAMAGE_AT_ONCE_FOR_MORALE_PENALTY, GetMaxHitPoints()/2);
...
************************* [Combat - Fighters] *********************************/
    ...
    //SetAIInteger(AI_RANGED_WEAPON_RANGE, d8(1));
