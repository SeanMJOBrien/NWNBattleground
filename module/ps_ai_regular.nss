...
************************* [Targeting] *****************************************/
    ...
    SetAIInteger(AI_MELEE_LAST_TO_NEW_TARGET_CHANCE, 30);
    SetAIInteger(AI_RANGED_LAST_TO_NEW_TARGET_CHANCE, 30);
    SetAIInteger(AI_SPELL_LAST_TO_NEW_TARGET_CHANCE, 30);
    ...
    if (d6() <= 4) AI_SetAITargetingValues(TARGETING_MANTALS, TARGET_LOWER, i1, i12);
    ...
    if (d6() <= 3)AI_SetAITargetingValues(TARGETING_RANGE, TARGET_HIGHER, i2, i9);
    else AI_SetAITargetingValues(TARGETING_RANGE, TARGET_LOWER, i2, i9);
    // Range - very imporant! Basis for all ranged/spell attacks.
    if (d6() <= 4)AI_SetAITargetingValues(TARGETING_AC, TARGET_LOWER, i2, i6);
    else AI_SetAITargetingValues(TARGETING_AC, TARGET_HIGHER, i2, i6);
    // AC is used for all phisical attacks. Lower targets lower (By default).
    if (d6() <= 4)AI_SetAITargetingValues(TARGETING_SAVES, TARGET_LOWER, i2, i4);
    else AI_SetAITargetingValues(TARGETING_SAVES, TARGET_HIGHER, i2, i4);
    ...
    if (d6() <= 4) AI_SetAITargetingValues(TARGETING_HITDICE, TARGET_LOWER, i1, i3);
...
************************* [Fleeing] *******************************************/
    ...
    SetAIInteger(HP_PERCENT_TO_CHECK_AT, 60);
...
************************* [Combat - Fighters] *********************************/
    ...
    SetAIInteger(AI_RANGED_WEAPON_RANGE, 2+d6());
