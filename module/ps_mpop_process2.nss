...
{
//WriteTimestampedLogEntry("MPOP GETHOSTILE OPEN.");
int nStrG = 0;
int nPlaceG= 0;
int nCountG= 1;
int nHostileG = FALSE;
...
//WriteTimestampedLogEntry("MPOP GETHOSTILE CLOSE.");
return nPlaceG;
}
...
{
//SpawnScriptDebugger();
//WriteTimestampedLogEntry("MPOP MOVE OPEN:"+GetName(oAreaWP));
...
//WriteTimestampedLogEntry("MPOP MOVE CLOSE:"+GetName(oAreaWP));

}

void MPOP_Cleanup()
{
//WriteTimestampedLogEntry("MPOP CLEANUP OPEN.");
int nNumber;
object oScan;
int nBuffer;
int nBuffer2;
...
//WriteTimestampedLogEntry("MPOP CLEANUP CLOSE.");
}
