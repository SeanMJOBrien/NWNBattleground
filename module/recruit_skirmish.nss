...
if (iCopper<2)
    {
    FloatingTextStringOnCreature("<cþ  >Requires 2 units of Copper.</c>",oPC,0);
    return;
    }
...
CreateObject(OBJECT_TYPE_CREATURE,"skirmish"+sGE,GetLocation(oPC));
...
SetLocalInt(oMod,sTeam+"cp",iCopper-2);
